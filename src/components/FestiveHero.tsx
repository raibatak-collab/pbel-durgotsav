...
export function FestiveHero() {
  ...
  return (
    <section className="w-full relative overflow-hidden py-10 md:py-16 px-3 sm:px-6 lg:px-8 border-b border-amber-500/20 text-white min-h-[520px] flex items-center justify-center box-border">
      ...
      <div className="absolute -top-24 -right-24 w-72 h-72 bg-red-600/25 rounded-full blur-3xl pointer-events-none" />

      <div className="w-full max-w-4xl mx-auto text-center relative z-10 space-y-4 sm:space-y-5 min-w-0 px-1 sm:px-4 box-border">
        
        {/* Bengali Devotional Invocation & Top Samiti Badge */}
        <div className="space-y-2 max-w-full">
          <div className="text-amber-300 font-semibold text-xs sm:text-sm tracking-normal sm:tracking-wide leading-relaxed px-2 break-words drop-shadow-md">
            ।। শ্রী শ্রী দুর্গোৎসবে সার্বজনীন সাদর আমন্ত্রণ ।। • শুভ শারদীয়া
          </div>
          <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-black/40 border border-amber-400/40 text-amber-300 text-[11px] sm:text-xs font-semibold tracking-wide backdrop-blur-md shadow-lg max-w-full">
            {branding.pssLogoUrl ? (
              <img
        ...
        {!timeLeft.isPassed && (
          <div className="inline-flex flex-col sm:flex-row items-center gap-2 sm:gap-3 bg-black/60 border border-amber-400/40 rounded-2xl px-3.5 py-2 sm:px-4 sm:py-2.5 backdrop-blur-md shadow-xl max-w-full">
            <div className="text-center sm:text-left">
              ...
              <div className="text-[11px] text-gray-300">Maha Sashti • 16 Oct</div>
            </div>
            <div className="hidden sm:block h-7 w-px bg-amber-400/30" />
            <div className="flex items-center gap-1.5 text-center">
              <div className="bg-amber-950/80 border border-amber-500/30 rounded-lg px-2 py-0.5 min-w-[32px]">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-2 text-xs sm:text-sm max-w-full px-2">
          <div className="w-full sm:w-auto bg-black/50 backdrop-blur-md border border-amber-400/30 px-3.5 py-1.5 rounded-2xl text-amber-200 flex items-center justify-center gap-2 shadow-sm text-xs">
        ...
        {/* Primary Action CTAs */}
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 max-w-2xl mx-auto w-full pt-1">
          <Link
            href="/contribute?tab=general"
            className="flex items-center justify-center gap-2 bg-gradient-to-r from-[#D99B26] to-[#B8801C] hover:from-[#B8801C] hover:to-[#966714] text-white px-4 py-3 rounded-2xl font-bold text-xs sm:text-sm transition-all shadow-xl hover:shadow-2xl hover:-translate-y-0.5 golden-glow text-center"
          >
